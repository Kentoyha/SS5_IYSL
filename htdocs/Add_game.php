...
<h1> Add New Game </h1>
    <form method="post">
        <table border=1 align="center" cellspacing="0" cellpadding="10">
            ...
            <tr>
                <td colspan="2">
                    <button type="submit" name="New_game"> Create</button>
                </td>
            </tr>
        </table>
    </form>
    ...
    if (isset($_POST['New_game'])) {
        ...
        $homeTeamCountQuery = "SELECT COUNT(*) as home_game_count FROM Game WHERE Home_team_id = '$Home_team' OR Away_team_id = '$Home_team'";
        $awayTeamCountQuery = "SELECT COUNT(*) as away_game_count FROM Game WHERE Home_team_id = '$Away_team' OR Away_team_id = '$Away_team'";
        
        $homeTeamResult = mysqli_query($conn, $homeTeamCountQuery);
        $awayTeamResult = mysqli_query($conn, $awayTeamCountQuery);
